...
const googleResolvers = {
    Mutation: {
        GoogleSignup: async (_, args) => {
            try {
                const { warehouse_name, warehouse_location, warehouse_address, warehouse_capacity, warehouse_phone, warehouse_email, googleUserData, role } = args.args;
...
exports.default = googleResolvers;
